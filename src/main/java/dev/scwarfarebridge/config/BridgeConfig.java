    ...
    static {
        ...
        RESISTANCE_FACTOR = builder
                .comment(
                        ...
                        "",
                        "Examples with default 0.70:",
                        "  Tank AP     (radius  4) -> ~2.8 block effect radius",
                        "  Tank HE     (radius 10) -> ~7.0 block effect radius",
                        "  GBU-57      (radius 22) -> ~15.4 block effect radius",
                        "  Nuke        (radius 30) -> ~21.0 block effect radius")
                .defineInRange("resistanceFactor", 0.70, 0.0, 1.0);

        MAX_DESTROY_CHANCE = builder
                .comment(
                        "Maximum chance (0.0-1.0) that a reinforced block at ground zero is destroyed.",
                        "1.0 = guaranteed destruction at epicenter.",
                        "Default: 1.0  |  Range: 0.0 - 1.0")
                .defineInRange("maxDestroyChance", 1.0, 0.0, 1.0);
